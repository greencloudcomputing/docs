...
This command clears you access token from the system. You will be prompted to make sure you are sure about logging out.s
...
This command will return useful information about the system and the account you are logged into.
...
👔 1 | 📌 ID → 6477283e599b4ee23e517101 | 🔆 Language → go | 🧭 Port → 8080

😁 What are you waiting for to create more?
...
```
$ ./gccli fx result -i 647733866aa774b558101974
👷 Validating inputs...
...
```
$ ./gccli fx restore -i 6477283e599b4ee92e5171231
👷 Validating inputs...
